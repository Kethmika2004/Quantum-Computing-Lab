...
| Environment setup | ✅ Done | Qiskit, Qiskit Runtime, IBM Quantum account, local simulator |
...
| Hardware experiments | ⬜ Not started | Real QPU runs, noise benchmarking |
...
\- \[`01-fundamentals/hello\_qubit.ipynb`](./01-fundamentals/hello\_qubit.ipynb) — my first circuit: a single qubit in superposition, measured 1000 times to show the 50/50 probability distribution
...
You'll also need a free IBM Quantum Platform account (https://quantum.cloud.ibm.com) if you want to run anything on real hardware — the simulator notebooks work with no account needed.
...
\- \*\*Written content\*\* (explanations, notes, documentation): \[Creative Commons Attribution 4.0 (CC BY 4.0)](https://creativecommons.org/licenses/by/4.0/) — free to reuse and adapt, with attribution.
